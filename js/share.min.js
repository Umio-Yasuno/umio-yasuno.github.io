...
function copy_url(type){const title=document.title;const url=location.href;const txt=(()=>{if(type===`title_url`)
return `${title}\n\n${url}`;else
return url;})();navigator.clipboard.writeText(txt).then(toast_msg());}
